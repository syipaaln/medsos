    ...
    <script>
        document.getElementById('videoInput').addEventListener('change', function (event) {
            ...
            if (file) {
                ...
                videoPreview.style.display = 'block'; // Tampilkan elemen video
            } else {
                videoPreview.style.display = 'none'; // Sembunyikan elemen video jika tidak ada file yang dipilih
            }
        });
    </script>
</body>
